    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="w-64 bg-slate-900 flex flex-col shrink-0">
        ...
        <nav className="flex-1 px-3 py-5 space-y-1">
          ...
          <Link to="/resources" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-700/50 font-medium text-sm transition-colors transition-all">
